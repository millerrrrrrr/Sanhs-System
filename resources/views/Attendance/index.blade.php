                ...
                <table class="min-w-full border border-gray-200 rounded-lg overflow-hidden">
                    <thead class="bg-[#660B05] text-white">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-center text-sm font-semibold uppercase tracking-wider">Morning Out</th>
                            <th class="px-6 py-3 text-center text-sm font-semibold uppercase tracking-wider">Morning Status</th>
                            <th class="px-6 py-3 text-center text-sm font-semibold uppercase tracking-wider">Student Status</th>
                            <th class="px-6 py-3 text-center text-sm font-semibold uppercase tracking-wider">Afternoon In</th>
                            <th class="px-6 py-3 text-center text-sm font-semibold uppercase tracking-wider">Afternoon Out</th>
                            <th class="px-6 py-3 text-center text-sm font-semibold uppercase tracking-wider">Afternoon Status</th>
                            <th class="px-6 py-3 text-center text-sm font-semibold uppercase tracking-wider">Student Status</th>
                        </tr>
                    </thead>
                    <tbody id="attendance-table">
                        ...
                        @empty
                            <tr>
                                <td colspan="10" class="py-4 text-center bg-white text-gray-500">No students found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
